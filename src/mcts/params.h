...
class SearchParams {
 public:
  ...
  bool GetPolicyScaledFpu(bool at_root) const {
    return at_root ? kPolicyScaledFpuAtRoot : kPolicyScaledFpu;
  }
 ...
 private:
  ...
  const bool kPolicyScaledFpu;
  const bool kPolicyScaledFpuAtRoot;
